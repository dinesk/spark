...
class flightDataTable extends config {
  ...
  def fetchData( v:String) = {
    ...
    spark_session.catalog.setCurrentDatabase("sample")
    ...
    spark_session.sql("select * from flight_data_table  order by op_carrier").show()
...
object flDTblObj extends Serializable{
  def main(args: Array[String]): Unit = {

    val obj = new flightDataTable
    obj.fetchData("dsf");
